# ------------
# copy from NerfingMVS:  Guided Optimization of Neural Radiance Fields for Indoor Multi-view Stereo
# ------------
import os
import cv2
import numpy as np
...
def align_scales(depth_priors, colmap_depths, colmap_masks, poses, sc, i_train, i_test):
    ...
    print('sc * ratio_priors:',sc * ratio_priors)
    exit()
...
def visualize_depth(depth, mask=None, depth_min=None, depth_max=None, direct=False):
    ...
    depth_color = depth_scaled_uint8[...,None]
